...
const uk = {
  ...
  rsvp: {
    ...
    attendingSingle: "Я буду присутній / присутня",
    hotelBooking: "Ми будемо бронювати номер у готелі",
    hotelBookingSingle: "Я буду бронювати номер у готелі",
    transferNeeded: "Нам потрібен трансфер",
    transferNeededSingle: "Мені потрібен трансфер",
    attendingChurch: "Ми будемо присутні на церковній церемонії",
    attendingChurchSingle: "Я буду присутній / присутня на церковній церемонії",
    roomType: "Тип номера",
    roomOptions: [
...
const en: Dict = {
  ...
  rsvp: {
    ...
    attendingSingle: "I\u2019ll be there",
    hotelBooking: "We\u2019ll book a room at the hotel",
    hotelBookingSingle: "I\u2019ll book a room at the hotel",
    transferNeeded: "We need a transfer",
    transferNeededSingle: "I need a transfer",
    attendingChurch: "We\u2019ll attend the church ceremony",
    attendingChurchSingle: "I\u2019ll attend the church ceremony",
    roomType: "Room type",
    roomOptions: [
