      ...
      >
        ...
        <div className="mt-10 lg:mt-14">
          <motion.div
            ...
            className="mb-6 overflow-hidden rounded-[2rem] bg-[#FAF7F2]/75 p-2 shadow-[0_24px_70px_rgba(80,68,52,0.1)] ring-1 ring-white/60 transition-shadow duration-500 hover:shadow-[0_32px_80px_rgba(80,68,52,0.18)]"
          >
            <div className="overflow-hidden rounded-[1.4rem] bg-[#E8DCCB]">
              <img
                src={venuePhotoUrl}
                alt="Yavir Resort"
                className="block h-[15rem] w-full object-cover transition-transform duration-700 hover:scale-[1.03] md:h-[22rem]"
                loading="lazy"
              />
            </div>
          </motion.div>
          ...
          <motion.div
            variants={itemVariants}
            className="overflow-hidden rounded-[2rem] bg-[#FAF7F2]/75 p-2 shadow-[0_24px_70px_rgba(80,68,52,0.1)] ring-1 ring-white/60"
          >
            <div className="relative overflow-hidden rounded-[1.4rem] bg-[#E8DCCB]">
              <iframe
              ...
              <div className="pointer-events-none absolute inset-x-0 bottom-0 bg-[linear-gradient(180deg,rgba(255,255,255,0)_0%,rgba(237,232,224,0.88)_100%)] px-5 pt-10 pb-5">
                <motion.div
                  initial={{ opacity: 0, y: 10 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: 0.4 }}
                  viewport={{ once: true }}
                  className="inline-flex items-center gap-2 rounded-full bg-[#FAF7F2]/92 px-3 py-2 shadow-[0_12px_30px_rgba(80,68,52,0.12)] ring-1 ring-[#E8DCCB]"
                >
